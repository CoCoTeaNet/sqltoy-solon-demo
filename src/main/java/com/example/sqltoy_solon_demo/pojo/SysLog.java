...
/*---begin-auto-generate-don't-update-this-area--*/	
	...
	@Id(strategy="generator",generator="org.sagacity.sqltoy.plugins.id.impl.ULIDGenerator")
	@Column(name="id",comment="日志编号",length=26L,type= Types.CHAR,nullable=false)
	private String id;
